...
export const INITIAL_TAREAS: TareaCCV[] = [
  ...
  {
    id: 't-107',
    titulo: 'Diseño 3D de Ambientes de Simulación Clínica',
    descripcion: 'Modelado y texturizado de salas quirúrgicas interactivas para posgrados.',
    proyecto_id: 'pry-2',
  ...
  {
    id: 't-108',
    titulo: 'Estandarización de 40 Plantillas Didácticas H5P',
    descripcion: 'Desarrollo de componentes reutilizables para el repositorio institucional.',
    proyecto_id: 'pry-3',
    proyecto_nombre: 'Banco Institucional de Objetos de Aprendizaje H5P',
    area_id: 'a-5',
    area_nombre: 'CMU',
    responsable_id: 'u-diseno',
    responsable_nombre: 'Lic. Carlic Bolomboy',
  ...
  {
    id: 't-109',
    titulo: 'Empaquetado y Pruebas LMS Canvas / Moodle',
    descripcion: 'Pruebas de compatibilidad y despliegue final de paquetes SCORM.',
    proyecto_id: 'pry-4',
    proyecto_nombre: 'Migración y Integración de Paquetes SCORM 2026',
    area_id: 'a-5',
    area_nombre: 'CMU',
    responsable_id: 'u-docente',
    responsable_nombre: 'Prof. Ana María Silva',
