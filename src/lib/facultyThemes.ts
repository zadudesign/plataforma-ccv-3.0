...
export const FACULTY_THEMES: Record<string, FacultyThemeConfig> = {
  ...
  sky: {
    ...
    bgLightHover: 'hover:bg-sky-50/90',
  ...
  green: {
    ...
    bgLightHover: 'hover:bg-green-50/90',
  ...
  lime: {
    ...
    bgLightHover: 'hover:bg-lime-50/90',
  ...
  orange: {
    ...
    bgLightHover: 'hover:bg-orange-50/90',
  ...
  yellow: {
    ...
    bgLightHover: 'hover:bg-yellow-50/90',
  ...
  red: {
    ...
    bgLightHover: 'hover:bg-red-50/90',
  ...
  pink: {
    ...
    bgLightHover: 'hover:bg-pink-50/90',
  ...
  fuchsia: {
    ...
    bgLightHover: 'hover:bg-fuchsia-50/90',
  ...
  violet: {
    ...
    bgLightHover: 'hover:bg-violet-50/90',
  ...
  zinc: {
    ...
    bgLightHover: 'hover:bg-zinc-50/90',
  ...
  stone: {
    ...
    bgLightHover: 'hover:bg-stone-50/90',
