...
export const LoginForm: React.FC<LoginFormProps> = ({ onSuccess }) => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 font-sans relative overflow-hidden">
      ...
      <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-sky-100/50 rounded-full blur-3xl pointer-events-none" />

      <div className="w-full max-w-md bg-white rounded-3xl border border-slate-200 shadow-2xl p-8 z-10 relative animate-fadeIn">
        {/* Header */}
